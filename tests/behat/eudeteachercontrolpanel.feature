...
Scenario: Check course distribution
    ...
    And I should see "Cat1" in the ".col-md-12 > div:nth-child(2) > div:nth-child(1) > div:nth-child(2) > li:nth-child(1) > div:nth-child(1) > a:nth-child(1) > span:nth-child(1)" "css_element"
