...
Feature: Test the 'integratedata' feature works.
  ...
  Background: 
    ...
    And the following "courses" exist:
      ...
      | CAT1     | Cat1.Normal course 1    | C1       |
      | CAT1     | Cat2.Normal course 2    | C2       |
      | CAT2     | MI.Cat1.Normal course 1 | C3       |
      | CAT2     | MI.Cat2.Normal course 2 | C4       |
  ...
  Scenario: Integrate correct data with an admin user.
    ...
    """
    CREATE;student1@example.com;MI.Cat1.Normal course 1;21/01/2017;1
    CREATE;student2@example.com;MI.Cat2.Normal course 2;21/01/2017;2
    DELETE;student1@example.com;MI.Cat1.Normal course 1
    CREATE;student2@example.com;MI.Cat2.Normal course 2;21/01/2017;4
    """
